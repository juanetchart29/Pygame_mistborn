...
introduccion2 = pygame.transform.scale(introduccion1,TAMAÑO_PANTALLA)

introduccion3 = "src/menu/prefinal.png"
introduccion3 = pygame.image.load(introduccion3)
introduccion3 = pygame.transform.scale(introduccion1,TAMAÑO_PANTALLA)
...
def historia(x):
    ...
    if x== 2:
        while True: 
            ...
            NEXT_LVL = Button(image=pygame.image.load("src/menu/Play Rect.png"), pos=(1346, 569), 
